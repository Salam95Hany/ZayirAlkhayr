...
@Component({
  selector: 'app-expenses-monthly-report',
  templateUrl: './expenses-monthly-report.component.html',
  styleUrls: ['./expenses-monthly-report.component.css']
})
export class ExpensesMonthlyReportComponent implements OnInit {
StatisticData: any;
  SalesData: any[] = [];
