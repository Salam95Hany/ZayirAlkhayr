...
import { AddFamilyStatusModel, FamilyDetails } from 'src/app/Admin/Models/GeneralStatus/AddFamilyStatusModel';
import { ToastrService } from 'ngx-toastr';

@Component({
  selector: 'app-family-status-sidepanel',
  templateUrl: './family-status-sidepanel.component.html',
  styleUrls: ['./family-status-sidepanel.component.css']
})
